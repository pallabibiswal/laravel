...
<div class="container">
	<div><h1 class="well cen">Registration Form</h1></div>
		<div class="col-lg-12 well">
			<div class="row">
				<form action="/postData" method='post' name = 'registration'>
				<?php echo csrf_field(); ?>
						...
						<div class="row">
							...
							<div class="row">
								<div class="col-sm-6">
									...
									value="<?php echo e(old('rpin')); ?>"/>
									<div>
										<?php if($errors->has('rpin')): ?>
											<span class="  text-danger">
											<?php echo e($errors->first('rpin')); ?>
									...
									<input type="text" id="rfax_input"
									 ...
									 value="<?php echo e(old('rfax')); ?>"/>
									<div>
										<?php if($errors->has('rfax')): ?>
											<span class="  text-danger">
											<?php echo e($errors->first('rfax')); ?>
							...
							<div class="col-sm-6">	
								...
								value="<?php echo e(old('opin')); ?>"/>
								<div>
									<?php if($errors->has('opin')): ?>
										<span class="  text-danger">
										<?php echo e($errors->first('opin')); ?>
								...
								value="<?php echo e(old('ofax')); ?>"/>
								<div>
									<?php if($errors->has('ofax')): ?>
										<span class="  text-danger">
										<?php echo e($errors->first('ofax')); ?>
